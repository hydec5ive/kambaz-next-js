...
export default function UrlEncoding() {
  ...
  return (
    <div style={{ padding: 40, maxWidth: 600 }}>
      ...
      <button onClick={goToQueryVersion} className="btn btn-success w-100 mb-2">{a} + {b} → Query Params (programmatic)</button>
      <button onClick={goToPathVersion} className="btn btn-success w-100 mb-2">{a} + {b} → Path Params (programmatic)</button>
